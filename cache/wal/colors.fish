...
set fish_pager_color_completion A6ADC8 --background=45475A
set fish_pager_color_description $fish_color_quote yellow
set fish_pager_color_progress 94E2D5 --background=45475A
