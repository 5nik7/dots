...
$null = New-Module starship {
  ...
  function global:prompt {
    ...
    $promptText = if ($script:TransientPrompt) {
      ...
      Invoke-Native -Executable 'C:\ProgramData\scoop\shims\starship.exe' -Arguments $arguments
    }
  ...
  Set-PSReadLineOption -ContinuationPrompt (
    Invoke-Native -Executable 'C:\ProgramData\scoop\shims\starship.exe' -Arguments @(
      "prompt",
      "--continuation"
    )
  )
