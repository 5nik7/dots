<#
    ...
    .EXAMPLE
    Set-Env -Name 'MyEnvironmentVariable' -Value 'Value1' -ForProcess
    ...
    .EXAMPLE
    Set-Env -Name 'MyEnvironmentVariable' -Value 'Value1' -ForComputer
    ...
    .EXAMPLE
    Set-Env -Name 'SomeUsersEnvironmentVariable' -Value 'SomeValue' -ForUser -Credential $userCreds
...
if ( $PSCmdlet.ParameterSetName -eq 'ForSpecificUser' ) {
  Invoke-PowerShell -FilePath (Join-Path -Path $PSScriptRoot -ChildPath '..\bin\Set-Env.ps1' -Resolve) `
