...
- [~] Generate shell completion data: approved bounded Zsh generation under [decision 0005](../docs/decisions/0005-static-zsh-completion.md); native acceptance tracked in the Phase 2 plan. Bash, Fish and PowerShell remain deferred.
