...
Plans describe active or proposed work. Durable architecture and behavior belong in `docs/`; plans link to those references rather than redefining them.
...
- State whether a plan is proposed, active, blocked, or completed.
